    ...
    <main class="py-20">
        ...
        <article class="prose mx-auto">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Application</strong> refers to [APP_NAME], the software program provided by the Company.
                    </p>
                </li>
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                        &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to [COMPANY_NAME],
                        [COMPANY_ADDRESS].</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to [COMPANY_NAME], accessible from <a href="%5BWEBSITE_URL%5D"
                            rel="external nofollow noopener" target="_blank">[WEBSITE_URL]</a></p>
                </li>
                <li>
